(()=>{
  ...
  const css=`
    ...
    :root[data-ls-theme="dark"] .ls-menu-dialog{background:#151515;color:#fff}.ls-menu-dialog{color:#102033}:root[data-ls-theme="dark"] .ls-menu-head{border-color:#303030}:root[data-ls-theme="dark"] .ls-menu-head strong,:root[data-ls-theme="dark"] .ls-menu-close,:root[data-ls-theme="dark"] .ls-menu-links a{color:#fff}:root[data-ls-theme="dark"] .ls-menu-links a{border-color:#303030}:root[data-ls-theme="dark"] .ls-menu-links span{color:#aab3be}
